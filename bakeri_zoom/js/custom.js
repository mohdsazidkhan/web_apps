jQuery(document).ready(function() {
    ...
    if(count==1){	
        ...
        //	$('.bakeri_main_image').addClass('zoom_level_one');
        //});
        $("body").on('touchmove', ".bakeri_first_zoom", function(e){
        $(".bakeri_first_zoom").draggable();
        });
    }
    else if(count==2){	
		$('.bakeri_main_image').removeClass('slide_zoom_main');
   ...
   /*Add to cart button*/
    ...
    /*Smallworld New Javascript Work starts*/
	/*var counter = 1;
    $("body" ).on("swipeleft",".slide-main", function(){
    ...
    $("body" ).on("swiperight",".slide-main", function(){
    	var data_bakery = $(this).attr("target_bakery");
